...
Compréhensions (lists / dicts / sets)

Structures imbriquées (datasets réels)

Bonnes pratiques & complexité
...
Supprimer les doublons d’une liste de labels

Calculer la moyenne des scores par individu

Extraire noms et âges depuis un dataset imbriqué

Compter les occurrences d’une variable cible

Reproduire un value_counts à la main
